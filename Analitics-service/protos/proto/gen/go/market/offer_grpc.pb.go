...
type OfferClient interface {
	...
	DeleteOffer(ctx context.Context, in *DeleteOfferRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *offerClient) CreateOffer(ctx context.Context, in *CreateOfferRequest, opts ...grpc.CallOption) (*OfferData, error) {
	out := new(OfferData)
	err := c.cc.Invoke(ctx, "/market.offer/CreateOffer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *offerClient) DeleteOffer(ctx context.Context, in *DeleteOfferRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/market.offer/DeleteOffer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *offerClient) GetActiveOffers(ctx context.Context, in *GetActiveOffersRequest, opts ...grpc.CallOption) (*GetActiveOffersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/market.offer/GetActiveOffers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *offerClient) GetOffersUser(ctx context.Context, in *GetOffersUserRequest, opts ...grpc.CallOption) (*GetOffersUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/market.offer/GetOffersUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OfferServer interface {
	...
	DeleteOffer(context.Context, *DeleteOfferRequest) (*emptypb.Empty, error)
...
func (UnimplementedOfferServer) DeleteOffer(context.Context, *DeleteOfferRequest) (*emptypb.Empty, error) {
...
func _Offer_CreateOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.offer/CreateOffer",
	}
...
func _Offer_DeleteOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.offer/DeleteOffer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Offer_GetActiveOffers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.offer/GetActiveOffers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Offer_GetOffersUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.offer/GetOffersUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
